...
data = {'data' : # в data вложены items имеет смысл исправить
        ...
        'items': [
            ...
            {'title': 'Хлеб', 'id': 2, 'image_name' : 'bread_for_astronauts.jpg' , 
              "text":""" В космосе каждая деталь меню тщательно 
            ...
            {'title': 'Молоток', 'id': 3, 'image_name' : 'space_hammer.jpg', 
              "text":""" Молоток - один из инструментов, который может понадобиться космонавтам в различных ситуациях на орбите. Он специально разработан с 
            ...
            {'title': 'Гаечный ключ', 'id': 4, 'image_name' : 'wrench.jpg'
             , 
              "text":""" Гаечный ключ - неотъемлемый инструмент в инвентаре космонавтов.
            ...
            {'title': 'Кофе', 'id': 6, 'image_name' : 'coffee.jpg', 
              "text":"""В глубоком космосе, где каждая деталь космического корабля на вес золота, космонавты ценят каждый момент и каждую глотку. Однако даже в 
            ...
            {'title': 'Шуруповерт', 'id': 7, 'image_name' : 'screwdriver.jpg', 
              "text":""" Шуруповерт - это неотъемлемый инструмент для космических ремонтных 
